...
define(
    function (require) {
        ...
        MarkLine.prototype = {
             ...
             * 核心对象，画图案的基本流程：
             *     brush - ctx.beginPath - buildLinePath - ctx.stroke - 
             *     brushSymbol - brushSymbol - drawText - restore
             */
            ...
            buildLinePath: function (ctx, style) {
                ...
                if (!style.lineType || style.lineType == 'solid') {
                    ...
                    // 如果设置smooth为‘spline’，好像就不显示了，奇怪
                    // 好像是一个BUG，致使 markLine 不支持曲线
                    if (style.smooth !== 'spline') {
                        // 直线
                        // dashLength 用于控制虚线的块状长度
